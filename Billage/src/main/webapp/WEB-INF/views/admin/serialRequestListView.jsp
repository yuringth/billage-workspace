               ...
               <div id="pagingArea" class="title">
                <ul class="pagination">
                	<c:choose>
                		...
                		<c:otherwise>
                		<li class="page-item"><a class="page-link" href="list.sr?cpage=${ pi.currentPage - 1 }">Previous</a></li>
                		</c:otherwise>
                	</c:choose>
                <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                    <li class="page-item"><a class="page-link" href="list.sr?cpage=${p}">${ p }</a></li>
                </c:forEach>
                <c:choose>
                	...
                	<c:otherwise>
	                    <li class="page-item"><a class="page-link" href="list.sr?cpage=${ pi.currentPage + 1 }">Next</a></li>
	                </c:otherwise>
	            </c:choose>
                </ul>
              </div>
