   ...
   <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
    <div class="wrapper">
        ...
        <div class="main_content">
			...
			<div class="table">
				<div class="tr header">
					<div class="td">요청번호</div>
					<div class="td">요청회원</div>
					<div class="td">요청제목</div>
					<div class="td">요청날짜</div>
					<div class="td">승락여부</div>
					<div class="td">비고</div>
				</div>
				<div class="tr body">
					<div class="td">1</div>
					<div class="td">책벌레</div>
					<div class="td">꼭 연재하고싶습니다</div>
					<div class="td">오늘</div>
					<div class="td">승락대기</div>
					<div class="td"></div>
				</div>
				<div class="tr body">
					<div class="td">1</div>
